...
class Files(models.Model):
    ...
    bucket_name = models.CharField(max_length=10, default=None, verbose_name='Minio桶名')
    object_name = models.CharField(max_length=20, default=None, verbose_name='Minio对象名')
